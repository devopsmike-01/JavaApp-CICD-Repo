#!/bin/bash
# Hardware requirements: Ubuntu 22.04 instance with mimum t2.micro type instance & port 3000 (grafana), 9100 (node-exporter) should be allowed on the security groups
...
sudo git clone -b installations https://github.com/Michaelgwei86/cicd-devops-fully-automated.git /tmp/devops-fully-automated
